...
//             <input id="searchbar-ref" placeholder="Search here..." className="form-input peer h-full w-60 rounded-full bg-slate-150 px-4 pl-9 text-xs+ text-slate-800 ring-primary/50 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:text-navy-100 dark:placeholder-navy-300 dark:ring-accent/50 dark:hover:bg-navy-900 dark:focus:bg-navy-900" type="text" />
...
//           <svg className="darkmode-moon size-6 text-amber-400" fill="currentColor" viewBox="0 0 24 24">
...
//           </svg>
//           <svg xmlns="http://www.w3.org/2000/svg" className="darkmode-sun size-6 text-amber-400" viewBox="0 0 20 20" fill="currentColor">
...
//           <button id="notification-ref" className="btn relative size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
...
const Topbar = () => {
  ...
  // };
  const togglePopover = () => {
    setIsPopoverVisible((prev) => !prev); // Toggle visibility on button click
  };
  return (
    <>
  ...
  <div className="header-container relative flex w-full bg-white dark:bg-navy-700 print:hidden">
    ...
    <div className="flex w-full items-center justify-between">
      ...
      <div className="size-7">
        ...
        <button  onClick={toggleDrawer}  className="sidebar-toggle ml-0.5 flex size-7 flex-col justify-center space-y-1.5 text-primary outline-none focus:outline-none dark:text-accent-light/80">
          <span />
          <span />
          <span />
        </button>
      ...
      <div className="-mr-1.5 flex items-center space-x-2">
        ...
        {/* Notification*/}
        <div id="notification-wrapper" className="flex">
          <button    onClick={togglePopover} id="notification-ref"  className="btn relative size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            <svg xmlns="http://www.w3.org/2000/svg" className="size-5 text-slate-500 dark:text-navy-100" stroke="currentColor" fill="none" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15.375 17.556h-6.75m6.75 0H21l-1.58-1.562a2.254 2.254 0 01-.67-1.596v-3.51a6.612 6.612 0 00-1.238-3.85 6.744 6.744 0 00-3.262-2.437v-.379c0-.59-.237-1.154-.659-1.571A2.265 2.265 0 0012 2c-.597 0-1.169.234-1.591.65a2.208 2.208 0 00-.659 1.572v.38c-2.621.915-4.5 3.385-4.5 6.287v3.51c0 .598-.24 1.172-.67 1.595L3 17.556h12.375zm0 0v1.11c0 .885-.356 1.733-.989 2.358A3.397 3.397 0 0112 22a3.397 3.397 0 01-2.386-.976 3.313 3.313 0 01-.989-2.357v-1.111h6.75z" />
            </svg>
            <span className="absolute -top-px -right-px flex size-3 items-center justify-center">
          ...
          {isPopoverVisible && (
          // <div id="notification-box" className="popper-root">
          <div id="notification-box" className=" absolute top-full right-0 mt-12 w-64 bg-white border shadow-lg rounded" >
